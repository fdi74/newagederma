...
.ld-laser-videos { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
.ld-laser-video-card { position: relative; border-radius: 20px; overflow: hidden; background: #1a2e25; aspect-ratio: 9 / 16; }
.ld-laser-video-card::after { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse at center, rgba(78,205,196,0.10), transparent 70%); pointer-events: none; }
.ld-laser-video-card video { width: 100%; height: 100%; object-fit: cover; display: block; position: relative; }
...
<div className="ld-laser-videos">
<div className="ld-laser-video-card">
<video autoPlay muted loop playsInline poster="/lift-diamond-laser-poster.jpg">
<source src="/lift-diamond-laser-loop.mp4" type="video/mp4" />
</video>
</div>
<div className="ld-laser-video-card">
<video autoPlay muted loop playsInline poster="/lift-diamond-skin-poster.jpg">
<source src="/lift-diamond-skin-loop.mp4" type="video/mp4" />
</video>
</div>
</div>
<div>
...
<p className="ld-cta-desc">Avaliação personalizada com o Dr. Fabricio Dall'Igna em Balneário Camboriú e Curitiba. Descubra se o Protocolo Lift Diamond é ideal para você.</p>
